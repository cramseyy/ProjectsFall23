...
public class A4GradedDriver {
	public static void main(String[] args) {
		...
		//GradedCourse object stored in Course object reference variable
		Course cou = new GradedCourse("Underwater Basket Weaving", 90, 80, 70, 60);
